...
#4G RAM
sleep 10
docker exec -u root -ti odoo-v15_web_1 /bin/sh -c "echo limit_time_real = 320 >> /etc/odoo/odoo.conf"

docker exec -u root -ti odoo-v15_web_1 pip3 install -r /mnt/extra-addons/requirements.txt 
