...
#docker exec -u root -ti odoo-v14_web_1 /bin/sh -c "echo limit_memory_hard = 3684354560 >> /etc/odoo/odoo.conf"
#docker exec -u root -ti odoo-v14_web_1 /bin/sh -c "echo limit_memory_soft = 3184354560 >> /etc/odoo/odoo.conf"
#docker exec -u root -ti odoo-v14_web_1 /bin/sh -c "echo list_db = False >> /etc/odoo/odoo.conf"
docker restart odoo-v14_web_1

sleep 10

docker exec -u root -ti odoo-v14_web_1 apt-get -y update
docker exec -u root -ti odoo-v14_web_1 apt-get -y install procps vim
